                            ...
                            <tbody class="text-gray-600 text-sm font-light">
                                @forelse ($kontens as $konten)
                                    <tr class="border-b border-gray-200 hover:bg-gray-100">
                                        <td class="py-3 px-6 text-left">{{ $konten->judul }}</td>
                                        <td class="py-3 px-6 text-left">{{ $konten->user->nama_lengkap }}</td>
                                        <td class="py-3 px-6 text-center">
                                            ...
                                            @else
                                                <span
                                                    class="bg-yellow-200 text-yellow-600 py-1 px-3 rounded-full text-xs">Draft</span>
                                            @endif
                                        </td>
                                        <td class="py-3 px-6 text-center">
                                            <div class="flex item-center justify-center">

                                                <a href="{{ route('admin-data.konten.show', $konten->id_konten) }}"
                                                    class="w-6 mr-4 transform hover:scale-110 text-green-600 hover:text-green-900">
                                                ...
                                                <form
                                                    action="{{ route('admin-data.konten.destroy', $konten->id_konten) }}"
                                                    method="POST"
