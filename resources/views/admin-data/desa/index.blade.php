                    ...
                    <div class="p-6 text-gray-900">
                        ...
                        <div
                            ...
                            <form method="GET" action="{{ route('admin-data.desa.index') }}"
                                ...
                                <div class="w-full md:w-auto">
                                    ...
                                    <div class="relative">
                                        <select name="per_page" onchange="this.form.submit()"
                                            class="rounded-lg border-gray-300 text-sm focus:ring-blue-500 focus:border-blue-500 cursor-pointer bg-gray-50 h-[42px] w-full md:w-auto"
                                ...
                                <div class="w-full md:w-auto">
                                    <label class="block text-xs font-medium text-gray-700 mb-1">Filter Kecamatan</label>
                                    <select name="kecamatan_id" onchange="this.form.submit()"
                                        class="rounded-lg border-gray-300 text-sm focus:ring-blue-500 focus:border-blue-500 cursor-pointer w-full md:w-auto h-[42px]">
                                ...
                                <div class="w-full md:w-64">
                                    ...
                                    <div class="relative w-full">
                                        ...
                                        <input type="text" name="search" x-model="search"
                                            class="block w-full p-2 pl-10 pr-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500 h-[42px]"
