                ...
                <form action="{{ route('admin-data.desa.store') }}" method="POST">
                    ...
                    <div class="bg-gray-50 px-4 py-3 sm:flex sm:flex-row-reverse sm:px-6">
                        ...
                        <button type="button" onclick="closeModal('createModal')"
                            class="mt-3 inline-flex w-full justify-center rounded-md bg-gray-300 px-3 py-2 text-sm font-semibold text-gray-900 shadow-sm ring-1 ring-inset ring-gray-200 hover:bg-gray-200 sm:mt-0 sm:w-auto">Batal</button>
                    </div>
                </form>
            ...
            <div
                ...
                <form id="editForm" action="" method="POST">
                    ...
                    <div class="bg-white px-4 pb-4 pt-5 sm:p-6 sm:pb-4">
                        <div class="sm:flex sm:items-start">
                            <div class="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left w-full">
                                <h3 class="text-lg font-semibold leading-6 text-gray-900">Edit Nama Desa</h3>
                                <div class="mt-4 space-y-4">
                                    <div>
