                                            ...
                                            <td class="py-3 px-6 text-left text-sm leading-relaxed text-black">
                                                @if ($user->desa)
                                                    ...
                                                    <p class="mt-1">
                                                        ...
                                                        Kec. {{ $user->desa->kecamatan->nama_kecamatan ?? '' }}
                                                    </p>
                                                    <p class="mt-1">
                                                        {{ $user->desa->kecamatan->kab_kota ?? '' }},
                                                        Jawa Barat
                                                    </p>
                                                @else
                                                    <span
                                            ...
                                            <div class="sm:flex sm:items-start">
                                                ...
                                                <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left w-full">
                                                    <h3 class="text-lg leading-6 font-medium text-gray-900">Reset
                                                        Password User</h3>
                                                    <div class="mt-2">
                                                        <p class="text-sm text-gray-500 mb-4">Masukkan password baru
                                                            untuk: <span class="font-bold text-gray-800"
                                    ...
                                    <form :action="deleteActionUrl" method="POST">
                                        ...
                                        <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                                            <div class="sm:flex sm:items-start">
                                                ...
                                                <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left w-full">
                                                    <h3 class="text-lg leading-6 font-medium text-gray-900">Nonaktifkan
                                                        Pengguna</h3>
                                                    <div class="mt-2">
                                                        ...
                                                        <p class="text-sm text-red-500 mt-1">
                                                            Pengguna tidak akan bisa login lagi setelah dinonaktifkan.
                                                        </p>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="bg-gray-50 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
                                            <button type="submit"
                                                class="w-full inline-flex justify-center rounded-md border border-transparent shadow-sm px-4 py-2 bg-red-600 text-base font-medium text-white hover:bg-red-700 focus:outline-none sm:ml-3 sm:w-auto sm:text-sm transition">
                                                Ya, Nonaktifkan
                                            </button>
