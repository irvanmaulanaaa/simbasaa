                    ...
                    <li>
                        <div class="flex items-center">
                            ...
                            <a href="{{ route('admin-data.kecamatan.index') }}"
                                class="ms-1 text-lg font-medium text-gray-700 hover:text-green-600 md:ms-2">Manajemen Kecamatan</a>
                        </div>
                    </li>
                ...
                <div class="p-6 text-gray-900">
                    ...
                    <form action="{{ route('admin-data.kecamatan.update', $kecamatan->id_kecamatan) }}" method="POST">
                        ...
                        <div>
                            ...
                            <x-text-input id="nama_kecamatan" class="block mt-1 w-full" type="text" name="nama_kecamatan" :value="old('nama_kecamatan', $kecamatan->nama_kecamatan)" required autofocus />
                            <x-input-error :messages="$errors->get('nama_kecamatan')" class="mt-2" />
                        </div>

                        <div class="mt-4">
                            <x-input-label for="kab_kota" :value="__('Kabupaten/Kota')" />
                            <x-text-input id="kab_kota" class="block mt-1 w-full" type="text" name="kab_kota" :value="old('kab_kota', $kecamatan->kab_kota)" required />
