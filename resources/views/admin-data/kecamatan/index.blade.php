                    ...
                    <div class="flex flex-col md:flex-row justify-between items-center mb-6 space-y-4 md:space-y-0">
                        ...
                        <form method="GET" action="{{ route('admin-data.kecamatan.index') }}"
                            ...
                            <div class="relative w-full md:w-64">
                                ...
                                @if (request('search'))
                                    <a href="{{ route('admin-data.kecamatan.index', array_merge(request()->except('search'), ['search' => null])) }}"
                    ...
                    <div class="overflow-x-auto rounded-lg shadow border border-gray-200">
                        <table class="min-w-full bg-white">
                            ...
                            <tbody class="text-gray-600 text-sm font-light">
                                ...
                                @empty
                                    <tr>
                                        <td colspan="4" class="text-center py-8 text-gray-500">Data kecamatan tidak
                                            ditemukan.</td>
                                    </tr>
                                @endforelse
                            </tbody>
                ...
                <form action="{{ route('admin-data.kecamatan.store') }}" method="POST">
                    ...
                    <div class="bg-gray-50 px-4 py-3 sm:flex sm:flex-row-reverse sm:px-6">
                        ...
                        <button type="button" onclick="closeModal('createModal')"
                            class="mt-3 inline-flex w-full justify-center rounded-md bg-gray-300 px-3 py-2 text-sm font-semibold text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 hover:bg-gray-400 sm:mt-0 sm:w-auto">Batal</button>
                    </div>
                </form>
