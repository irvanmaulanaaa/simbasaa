                ...
                <div class="p-6 text-gray-900 relative">
                    ...
                    <div x-data="{ 
                        ...
                        <div x-show="submitting"
                            ...
                            style="display: none;">
                            <div class="animate-spin rounded-full h-16 w-16 border-t-4 border-b-4 border-green-600 mb-4">
                            </div>
                        ...
                        <form action="{{ route('admin-pusat.sampah.update', $sampah->id_sampah) }}" method="POST"
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                                ...
                                <div>
                                    ...
                                    <x-text-input id="nama_sampah" class="block mt-1 w-full" type="text"
                                        name="nama_sampah" :value="old('nama_sampah', $sampah->nama_sampah)" required autofocus />
                                ...
                                <div>
                                    ...
                                    <p x-show="isDuplicate" class="text-sm text-red-600 mt-1 font-semibold animate-pulse" style="display: none;">
                                ...
                                <div>
                                    ...
                                    <x-text-input id="kode_bsb" class="block mt-1 w-full uppercase" type="text"
                                        name="kode_bsb" :value="old('kode_bsb', $sampah->kode_bsb)" required />
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div>
                                    ...
                                    <select id="UOM" name="UOM"
                                        class="block mt-1 w-full border-gray-300 focus:border-green-500 focus:ring-green-500 rounded-md shadow-sm cursor-pointer"
                                        required>
                                        <option value="kg" {{ old('UOM', $sampah->UOM) == 'kg' ? 'selected' : '' }}>Kilogram (Kg)</option>
                                        <option value="pcs" {{ old('UOM', $sampah->UOM) == 'pcs' ? 'selected' : '' }}>Satuan (Pcs)</option>
                                    </select>
                                ...
                                <div>
                                    ...
                                    <select id="status_sampah" name="status_sampah"
                                        class="block mt-1 w-full border-gray-300 focus:border-green-500 focus:ring-green-500 rounded-md shadow-sm cursor-pointer"
                                        required>
                                        <option value="aktif" {{ old('status_sampah', $sampah->status_sampah) == 'aktif' ? 'selected' : '' }}>Aktif</option>
                                        <option value="tidak_aktif" {{ old('status_sampah', $sampah->status_sampah) == 'tidak_aktif' ? 'selected' : '' }}>Tidak Aktif</option>
                                    </select>
                                ...
                                <div>
                                    ...
                                    <div class="relative mt-1 rounded-md shadow-sm">
                                        ...
                                        <input type="number" name="harga_anggota" id="harga_anggota"
                                            ...
                                            placeholder="0" value="{{ old('harga_anggota', $sampah->harga_anggota) }}" required min="0">
                                    </div>
                                ...
                                <div>
                                    ...
                                    <div class="relative mt-1 rounded-md shadow-sm">
                                        ...
                                        <input type="number" name="harga_bsb" id="harga_bsb"
                                            class="block w-full rounded-md border-gray-300 pl-10 focus:border-green-500 focus:ring-green-500 sm:text-sm"
                                            placeholder="0" value="{{ old('harga_bsb', $sampah->harga_bsb) }}" required min="0">
                                    </div>
                            ...
                            <div class="flex items-center justify-end mt-8 border-t pt-4">
                                ...
                                <button type="submit"
                                    ...
                                    <span x-text="submitting ? 'Memperbarui...' : 'Perbarui Data Sampah'"></span>
                                </button>
                            </div>
                        </form>
                    </div>
