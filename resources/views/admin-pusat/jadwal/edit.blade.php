                ...
                <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
                    ...
                    <li>
                        <div class="flex items-center">
                            ...
                            <a href="{{ route('admin-pusat.jadwal.index') }}"
                                class="ms-1 text-sm font-medium text-gray-700 hover:text-green-600 md:ms-2">Jadwal
                                Penimbangan</a>
                        </div>
                    </li>
                    <li aria-current="page">
                        <div class="flex items-center">
                            ...
                            <span class="ms-1 text-sm font-medium text-gray-500 md:ms-2">Edit Jadwal</span>
                        </div>
                    </li>
                </ol>
            </nav>
