    ...
    <form method="POST" action="{{ route('login') }}" class="mt-8">
        ...
        <div class="mt-4" x-data="{ show: false }">
            ...
            <div class="relative mt-1">
                <x-text-input 
                    id="password" 
                    class="block w-full rounded-lg pr-10" 
        ...
        <div class="mt-6">
            <x-primary-button class="w-full justify-center py-3 rounded-lg text-base bg-green-600 hover:bg-green-700 transition duration-150 ease-in-out">
                {{ __('Masuk') }}
            </x-primary-button>
        </div>
    </form>
