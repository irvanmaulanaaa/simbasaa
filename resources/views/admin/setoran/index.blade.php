                            ...
                            <tbody class="text-gray-600 text-sm font-light">
                                @forelse ($setoran as $index => $item)
                                    <tr
                                        ...
                                        {{ $item->tipe == 'setor' ? 'bg-green-50' : 'bg-red-50' }}">

                                        <td class="py-3 px-6 text-left">{{ $index + $setoran->firstItem() }}</td>
                                        ...
                                        <td class="py-3 px-6 text-center">
                                            <div class="flex item-center justify-center">
                                                <a href="{{ route('admin.setoran.show', $item->id) }}"
                                                ...
                                                <form action="{{ route('admin.setoran.destroy', $item->id) }}"
                                                    method="POST"
                                ...
                                @empty
                                    <tr>
                                        <td colspan="6" class="text-center py-4">Belum ada data transaksi.</td>
                                    </tr>
                                @endforelse
                            </tbody>
                        </table>
